...
class Modules_Payment extends TOC_Controller
{
    ...
    public function install()
    {
        ...
        $data = array('title' => $class->get_title(), 'code' => $class->get_code(), 'author_name' => '', 'author_www' => '', 'modules_group' => 'payment', 'params' => json_encode($config));
    ...
    public function uninstall()
    {
        ...
        if ($this->extensions_model->uninstall('payment', $code)) {
            $response = array('success' => true, 'feedback' => lang('ms_success_action_performed'));
        } else {
            $response = array('success' => false, 'feedback' => lang('ms_error_action_not_performed'));
        }
