 ...
 */
  ...
  require_once 'information_dialog.php';
  require_once 'information_general_panel.php';
  require_once 'information_grid.php';
  require_once 'information_meta_info_panel.php';
?>
