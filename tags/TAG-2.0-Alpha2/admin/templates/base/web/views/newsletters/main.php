 ...
 */
  ...
  require_once 'newsletters_grid.php';
  require_once 'newsletters_dialog.php';
  require_once 'send_emails_dialog.php';
  require_once 'send_newsletters_dialog.php';
  require_once 'log_dialog.php';
?>
