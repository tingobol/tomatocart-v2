...
<form name="order" action="<?php echo base_url(); ?>" method="post" data-ajax="false">
    <div>
    ...
    <div class="submitFormButtons" style="text-align: right;">
    	<button type="submit" class="small button" data-role="button" data-theme="b"><?php echo lang('button_continue'); ?></button>
    </div>
</form>
