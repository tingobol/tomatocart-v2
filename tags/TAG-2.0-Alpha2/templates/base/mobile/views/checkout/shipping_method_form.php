                ...
                <td>
                    ...
                    ?>
                        ...
                        ?>
                            ...
                            <td align="right"><?php echo form_radio('shipping_mod_sel', $quote['id'] . '_' . $methods['id'], ($quote['id'] . '_' . $methods['id'] == $selected_shipping_method_id) ? TRUE : FALSE, 'id="' . $quote['id'] . '_' . $methods['id'] . '"'); ?></td>
                        <?php
                            else :
                        ?>
                			<td align="right" colspan="2"><?php echo currencies_display_price($methods['cost'], $quote['tax_class_id']) . osc_draw_hidden_field('shipping_mod_sel', $quote['id'] . '_' . $methods['id']); ?></td>
                        <?php
                            endif;
                        ?>
							<td width="10">&nbsp;</td>
...
<p align="right">
    <button type="submit" class="small button" id="btn-save-shipping-method" data-theme="b"><?php echo lang('button_continue'); ?></button>
</p>