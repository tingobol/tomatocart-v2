...
//      }
    ...
    function getProductReturnedQuantity($orders_products_id) {
      ...
      $Qreturn->bindInt(':orders_id', $this->id);
    ...
    function query($order_id) {
      ...
      $this->order_id = $Qorder->valueInt('orders_id');
      $this->invoice_number = $Qorder->value('invoice_number');
      $this->invoice_date = $Qorder->value('invoice_date');
      $this->date_purchased = $Qorder->value('date_purchased');
