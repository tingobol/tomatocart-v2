        ...
        items: [
            {
                ...
                html: [
                       ...
                       '<div class="feature main">',
                           '<img src="' + base_url + 'templates/default/mobile/resources/images/circle-touch.png" width="52" height="52">',
                       ...
                       '<h2>What&#8217;s new</h2>',
                       '<div class="feature">',
                       '<img src="' + base_url + 'templates/default/mobile/resources/images/circle-performance.png" width="52" height="52">',
                       '<h3>Unbelievable Performance</h3>',
                       '<p>Faster layouts and animations, smoother scrolling, and overall more responsive.</p>',
                       '</div>',
                       '<div class="feature">',
                       '<img src="' + base_url + 'templates/default/mobile/resources/images/circle-architecture.png" width="52" height="52">',
                       ...
                       '</div>',
                       '<div class="feature">',
                       '<img src="' + base_url + 'templates/default/mobile/resources/images/circle-native.png" width="52" height="52">',
                       '<h3>Native Packaging</h3>',
                       '<p>Sencha SDK Tools now allow you to build your app for App Store distribution, on Windows and Mac.</p>',
                       '</div>',
                       '<div class="feature">',
                       '<img src="' + base_url + 'templates/default/mobile/resources/images/circle-learn.png" width="52" height="52">',
                       '<h3>Easy to Learn</h3>',
                       ...
                       '</div>',
                       '</div>',
                       '<footer>Learn more at <a href="http://www.sencha.com/products/touch" target="blank">sencha.com/products/touch</a></footer>'].join('')
            },
            {
                id: 'mainNestedList',
                xtype : 'nestedlist',
