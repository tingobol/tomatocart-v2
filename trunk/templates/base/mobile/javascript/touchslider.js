...
touchslider = {
    ...
    touchEnd: function(/*JQuery*/ elem, /*event*/ e) {
         if (touchslider.getLeft(elem) > 0) {
              ...
              */
             touchslider.doSlide(elem, 0, '0.1s');
              ...
              */
           touchslider.doSlide(elem, '-' + (touchslider.width - elem.parent().width()), '0.1s');
    ...
    slideMomentum: function(/*jQuery*/ elem, /*event*/ e) {
         var slideAdjust = (new Date().getTime() - touchslider.touchStartTime) * 100;
