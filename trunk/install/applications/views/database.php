...
<div class="container clearfix">
    <div class="row-fluid">
    	...
    	<div class="span9 content">
            ...
            <form name="install" id="installForm" action="index.php?step=4" method="post" onsubmit="prepareDB(); return false;" class="form-horizontal">
                ...
                <div class="control-group">
                    <div class="controls pull-right">
                    	<a href="javascript:void(0);" class="btn" href="<?php echo site_url(); ?>"><i class="icon-remove"></i> &nbsp;<?php echo lang('image_button_cancel'); ?></a>
            			<a href="<?php echo site_url('index/index/webserver'); ?>" class="btn"><i class="icon-ok"></i> &nbsp;<?php echo lang('image_button_continue'); ?></a>
                    </div>
                </div>
            </form>
    	</div>
