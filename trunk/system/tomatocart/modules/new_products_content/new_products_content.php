 ...
 */
class New_Products_Content extends TOC_Module
{
    /**
    ...
    {
        //load model
        $this->load_model('new_products_content');

        $data['title'] = $this->title;

        //load products
        $products = $this->new_products_content->get_new_products($this->config['MODULE_CONTENT_NEW_PRODUCTS_MAX_DISPLAY']);
        if (count($products) > 0)
        {
...
/* End of file new_products_content.php */
/* Location: ./system/tomatocart/modules/new_products_content/new_products_content.php */