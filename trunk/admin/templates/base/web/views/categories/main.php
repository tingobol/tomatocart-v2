 ...
 */
  ...
  require_once 'categories_dialog.php';
  require_once 'categories_main_panel.php';
  require_once 'categories_general_panel.php';
  require_once 'categories_move_dialog.php';
  require_once 'categories_tree_panel.php';
  require_once 'categories_meta_info_panel.php';
?>
