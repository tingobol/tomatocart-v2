...
Ext.define('Toc.google_sitemap.GoogleSitemapDialog', {
  ...
  var dataStore = Ext.create('Ext.data.Store', {
      fields: ['id', 'text'],
      data: [
         {id:"daily",text:"<?php echo lang('Daily'); ?>"},
         {id:"monthly",text:"<?php echo lang('Monthly'); ?>"},
         {id:"yearly",text:"<?php echo lang('Yearly'); ?>"}
       ]
    });
    this.fsCreateSitemap = Ext.create('Ext.form.FieldSet', {
      ...
      { xtype: 'panel',
       ...
       {  
          ...
          defaultType: 'combo',   
          defaults: {
          	xtype: 'combo', store: dataStore, mode: 'local', 
          	valueField: 'id', 
          	displayField: 'text', 
          	value: 'daily', allowBlank: false, 
          	editable: false, triggerAction: 'all', anchor: '90%'
          },
          items: [ 
          	{            
