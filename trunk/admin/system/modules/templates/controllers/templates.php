...
class Templates extends TOC_Controller {
    ...
    /**
     * Display template module window
     */
    public function show()
    {
        $this->load->view('main');
        $this->load->view('templates_grid');
        $this->load->view('templates_settings_dialog');
        $this->load->view('templates_layouts_dialog');

        $this->load->view('modules_panel');
        $this->load->view('modules_groups_panel');
        $this->load->view('modules_settings_panel');
    }

    /*************************************************************************************************
     *
     * Actions for Template Manipulation Actions
     *
     ************************************************************************************************/
    ...
    public function list_templates ()
    {
        ...
        return array(EXT_JSON_READER_TOTAL => sizeof($templates), EXT_JSON_READER_ROOT => $templates);
    }
