 ...
 */
    ...
    require_once('articles_categories_dialog');
    require_once('articles_categories_grid');
    require_once('articles_categories_general_panel');
    require_once('articles_categories_meta_info_panel');
?>
