...
<head>
    ...
    <link rel="stylesheet"  href="<?php echo base_url();?>templates/default/pad/css/stylesheet.css" /> 
  ...
  <div data-role="page" class="type-index">
	    ...
	    <div data-role="navbar" class="nav-glyphish" data-grid="d">
		    <ul>
              ...
              <li><a href="<?php echo site_url('products/latest');?>" id="new-products" data-icon="custom"><?php echo lang('new_products');?></a></li>
              <li><a href="<?php echo site_url('products/specials');?>" id="specials" data-icon="custom"><?php echo lang('specials');?></a></li>
		      <li><a href="<?php echo site_url('account');?>" id="my-account" data-icon="custom"><?php echo lang('my_account');?></a></li>
              <li><a href="<?php echo site_url('info/contact_us');?>" id="contact-us" data-icon="custom"><?php echo lang('contact_us');?></a></li>    
