...
<form name="password_forgotten" action="<?php echo site_url('password_forgotten/process');?>" method="post">
    ...
    <div class="ui-grid-a">
    	<div class="ui-block-a">
			<a data-role="button" href="<?php echo site_url('account/login'); ?>" data-theme="a"><?php echo lang('button_back'); ?></a>
    	</div>
    	<div class="ui-block-b">
            <button type="submit" data-role="button" data-theme="b"><?php echo lang('button_continue'); ?></button>
    	</div>
    </div>
